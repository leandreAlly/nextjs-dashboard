...
const Contact = () => {
  return (
    <>
      <section className="relative z-50 overflow-hidden py-20 lg:py-[120px]">
        <div className="container">
          <div className="mx-[80px] flex flex-wrap lg:justify-between">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">
                      KG 500S.t Kigali/Nyarugenge 28292. Rwanda
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="border-primary bg-primary w-full rounded border bg-blue-500 p-3 text-white transition hover:bg-blue-600"
                    >
                      Send Message
                    </button>
                  </div>
